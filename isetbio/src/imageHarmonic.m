...
if ~exist('parms', 'var')
    ...
    if isfield(parms, 'signalGridSize'), dparms.signalGridSize = parms.signalGridSize; end
    if isfield(parms, 'signalLocation'), dparms.signalLocation = parms.signalLocation; end
    if isfield(parms, 'gridZoom'), dparms.gridZoom = parms.gridZoom; end
    parms = dparms;
end
