...
if __name__ == '__main__':
    ...
    super_path = '/share/wandell/data/reith/redo_experiments/lines_mtf_experiments/mtf_lines_shift_new_freq_lower_values'
    ...
    super_path = '/share/wandell/data/reith/redo_experiments/lines_mtf_experiments/mtf_lines_angle_new_freq_lower_values'
    fpaths = [p.path for p in os.scandir(super_path) if p.is_dir()]
    fpaths.sort(key=lambda x: int(x.split('_')[-1]))
    for fpath in fpaths:
