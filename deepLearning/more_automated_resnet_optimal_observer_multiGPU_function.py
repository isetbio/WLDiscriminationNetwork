...
if __name__ == '__main__':
    ...
    # run_on_folder('/share/wandell/data/reith/coneMosaik/weird_results_backup/static_case_freq1_var_contrasts/', separate_rgb=True, svm=True)
    run_on_folder('/share/wandell/data/reith/coneMosaik/static_case_freq1_var_contrasts_rgb/', separate_rgb=True, svm=True, NetClass=NotPretrainedResnet)
