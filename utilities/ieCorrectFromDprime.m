function fractionCorrect = ieCorrectFromDprime(dPrime)
% Area under ROC curve for a normal distribution d-prime and then fraction
% correct.
%
% fractionCorrect = ieCorrectFromDprime(dPrime)
%
% NC, ISETBIO Team
%
% Includes
%     ComputeROCArea, ComputeDPrimeCritNorm, AnalyticpHitpFa
%
% See also 
%   iePoissonIdealObserver,
